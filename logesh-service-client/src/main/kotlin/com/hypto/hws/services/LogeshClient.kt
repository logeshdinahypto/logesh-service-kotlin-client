...
import com.hypto.hws.services.LogeshGrpcKt.LogeshCoroutineStub
import io.grpc.ManagedChannel
import io.grpc.ManagedChannelBuilder
import java.io.Closeable
import java.util.concurrent.TimeUnit

class LogeshClient(private val channel: ManagedChannel) : Closeable {
    private val stub: LogeshCoroutineStub = LogeshCoroutineStub(channel)
